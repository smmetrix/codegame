...
GUIDE_SECTIONS: Final[tuple[dict[str, object], ...]] = (
    ...
    },
    {
        ...
        "paragraphs": (
            ...
            "Защищённая цель может запустить контр-взлом: завершите мини-игру раньше красной шкалы, чтобы получить +20% BTC.",
            "Поражение в контр-взломе отнимает 0.01 BTC, повышает подозрение на 3% и блокирует цель на 2 минуты.",
            "Раз в 20–30 минут начинается сетевой шторм. Его цвет, таймер и глобальный эффект отображаются в панели задач.",
            "Зелёная утечка упрощает цели, красная полиция усиливает подозрение и атаки, жёлтый крипто-бум утраивает доход.",
            "Синяя DDoS-волна удваивает HP серверов и сохраняет ботнеты; фиолетовая пятница снижает цены DarkNet вдвое.",
...
# Контр-взлом: вероятность зависит от итогового уровня цели.
counter_hack_chance: Final[dict[int, float]] = {
    1: 0.05,
    2: 0.10,
    3: 0.20,
    4: 0.30,
...
COUNTER_HACK_SPEED_BY_LEVEL: Final[dict[int, float]] = {
    1: 2.0,
    2: 3.5,
    3: 5.0,
    4: 6.5,
...
COUNTER_HACK_TRIGGER_DELAY_MIN_SECONDS: Final[float] = 3.0
COUNTER_HACK_TRIGGER_DELAY_MAX_SECONDS: Final[float] = 5.0
COUNTER_HACK_ALERT_SECONDS: Final[float] = 2.0
COUNTER_HACK_SUCCESS_NOTICE_SECONDS: Final[float] = 3.0
COUNTER_HACK_FRAME_PERIOD_SECONDS: Final[float] = 2.0
COUNTER_HACK_FRAME_FLASH_SECONDS: Final[float] = 0.2
COUNTER_HACK_FAILURE_GLITCH_SECONDS: Final[float] = 1.0
COUNTER_HACK_TARGET_COOLDOWN_SECONDS: Final[float] = 120.0
COUNTER_HACK_BTC_PENALTY: Final[float] = 0.01
COUNTER_HACK_SUSPICION_PENALTY: Final[float] = 3.0
COUNTER_HACK_REWARD_MULTIPLIER: Final[float] = 1.20
COUNTER_HACK_BAR_RECT: Final[tuple[int, int, int, int]] = (440, 82, 400, 20)
COUNTER_HACK_BAR_BACKGROUND_HEX: Final[str] = "#330000"
COUNTER_HACK_BAR_FILL_HEX: Final[str] = "#ff0000"
COUNTER_HACK_LABEL_CENTER: Final[tuple[int, int]] = (640, 76)
COUNTER_HACK_CRITICAL_CENTER: Final[tuple[int, int]] = (640, 112)
COUNTER_HACK_ALERT_RECT: Final[tuple[int, int, int, int]] = (220, 132, 840, 82)
COUNTER_HACK_FAILURE_PANEL_RECT: Final[tuple[int, int, int, int]] = (
    265,
    184,
    750,
    370,
)
COUNTER_HACK_FAILURE_BUTTON_RECT: Final[tuple[int, int, int, int]] = (
    470,
    474,
    340,
    54,
)
COUNTER_HACK_FAILURE_TITLE_CENTER: Final[tuple[int, int]] = (640, 316)
COUNTER_HACK_FAILURE_DETAIL_CENTER: Final[tuple[int, int]] = (640, 382)
COUNTER_HACK_GLITCH_SLICE_COUNT: Final[int] = 22
COUNTER_HACK_GLITCH_MAX_OFFSET: Final[int] = 28
COUNTER_HACK_CRITICAL_THRESHOLD: Final[float] = 80.0

# Сетевые штормы: глобальные модификаторы с таймером реального времени.
storm_types: Final[list[dict[str, object]]] = [
    {
        "name": "Утечка данных",
        "color": "#00ff88",
        "icon": "🟢",
        "effect": "targets_easier",
        "duration": 180,
        "desc": "Все цели -2 сложность, награды x0.5",
    },
    {
        "name": "Кибер-полиция",
        "color": "#ff4444",
        "icon": "🔴",
        "effect": "suspension_x2",
        "duration": 180,
        "desc": "Подозрение растёт x2, атаки x2",
    },
    {
        "name": "Крипто-бум",
        "color": "#ffdd00",
        ...
        "effect": "income_x3",
        "duration": 120,
        "desc": "Все доходы x3, Даркнет закрыт",
    },
    {
        "name": "DDoS-волна",
        "color": "#4488ff",
        ...
        "effect": "servers_hard",
        "duration": 150,
        "desc": "Серверы x2 HP, ботнеты бесплатны",
    },
    {
        "name": "Тёмная пятница",
        "color": "#aa44ff",
        ...
        "duration": 120,
        "desc": "Даркнет -50%, только 2 минуты!",
    },
]
STORM_INTERVAL_MIN_SECONDS: Final[int] = 1200
STORM_INTERVAL_MAX_SECONDS: Final[int] = 1800
STORM_ANNOUNCEMENT_SECONDS: Final[float] = 3.0
STORM_END_NOTIFICATION_SECONDS: Final[float] = 3.0
STORM_TARGET_DIFFICULTY_REDUCTION: Final[int] = 2
STORM_ORDER_REWARD_MULTIPLIER: Final[float] = 0.50
STORM_POLICE_SUSPICION_MULTIPLIER: Final[float] = 2.0
STORM_POLICE_ATTACK_SPEED_MULTIPLIER: Final[float] = 2.0
STORM_INCOME_MULTIPLIER: Final[float] = 3.0
STORM_SERVER_HP_MULTIPLIER: Final[float] = 2.0
STORM_SHOP_DISCOUNT_MULTIPLIER: Final[float] = 0.50
STORM_FRAME_WIDTH: Final[int] = 5
STORM_TASKBAR_STATUS_RECT: Final[tuple[int, int, int, int]] = (404, 4, 150, 28)
STORM_ANNOUNCEMENT_TITLE_CENTER: Final[tuple[int, int]] = (640, 226)
STORM_ANNOUNCEMENT_NAME_CENTER: Final[tuple[int, int]] = (640, 316)
STORM_ANNOUNCEMENT_DESC_CENTER: Final[tuple[int, int]] = (640, 376)
STORM_ANNOUNCEMENT_DURATION_CENTER: Final[tuple[int, int]] = (640, 426)
STORM_GLOBE_CENTER: Final[tuple[int, int]] = (640, 158)
STORM_GLOBE_RADIUS: Final[int] = 35
STORM_DARKNET_CLOSED_MESSAGE: Final[str] = "Даркнет недоступен во время шторма"
...
class ZeroDayApp:
    ...
    def __init__(self) -> None:
        ...
        self.counter_hack_random = random.Random()
        self.storm_random = random.Random()
        self._reset_live_events()
        self._reset_counter_hack_system(clear_cooldowns=True)
        self._reset_network_storm()
    ...
    def _dynamic_attack_music_forced(self) -> bool:
        counter_attack = bool(self.counter_hack.get("triggered")) and (
            bool(self.counter_hack.get("active"))
            or bool(self.counter_hack.get("failed"))
        )
        return (
            bool(self.hot_deal.get("active"))
            or bool(self.storm_state.get("active"))
            or counter_attack
        )

    def _desired_auto_music_track(self) -> str:
        if self._dynamic_attack_music_forced():
            return "track_attack"
        attack_warning = (
    ...
    def _live_events_can_start(self) -> bool:
        return (
            ...
            and float(self.storm_state.get("announcement_timer", 0.0)) <= 0.0
    ...
    def _hot_deal_message(self, order: dict[str, object]) -> str:
        reward = self._payable_order_reward(order)
        return (
            f"{HOT_DEAL_MESSAGE}\n"
            f"Цель: {order['target']}\n"
            f"Тип: {order['type']}\n"
            f"Задача: {order['description']}\n"
            f"Награда x3: ₿ {reward:.3f}"
        )
    ...
    def _process_hot_deal(self, decision: str) -> None:
        ...
        if (
            ...
            return
        cooldown_context = {
            "target": order.get("target", "горячая цель"),
            "target_type": order.get("target_type", "Обычный ПК"),
        }
        if (
            decision == "accepted"
            and self._target_cooldown_remaining(cooldown_context, "") > 0.0
        ):
            self._push_notification(
                self._target_cooldown_message(cooldown_context, ""),
                COLOR_ERROR,
                force=True,
            )
            return
    ...
    def _complete_hot_deal(self) -> str:
        ...
        paid_reward = self._change_balance(
            reward,
            f"Горячий заказ #{int(order['id']):03d}",
        )
        message = f"🔥 ГОРЯЧИЙ ЗАКАЗ ВЫПОЛНЕН! +{paid_reward:.3f} BTC!"
        self._append_messenger_message(
            customer,
            "incoming",
            message,
    ...
    @staticmethod
    def _blank_counter_hack() -> dict[str, object]:
        return {
            "active": False,
            "enemy_progress": 0.0,
            "enemy_speed": 0.0,
            ...
            "elapsed": 0.0,
            "failed": False,
            "failure_glitch_timer": 0.0,
            "target_key": "",
            "target_name": "",
            "success_notice_timer": 0.0,
            "success_notice": "",
            "suspicion_added": 0.0,
        }

    def _reset_counter_hack_system(self, *, clear_cooldowns: bool = False) -> None:
        self.counter_hack = self._blank_counter_hack()
        if clear_cooldowns or not hasattr(self, "counter_hack_cooldowns"):
            self.counter_hack_cooldowns: dict[str, float] = {}

    def _clear_counter_hack_attempt(self, *, preserve_notice: bool = True) -> None:
        notice_timer = (
            float(self.counter_hack.get("success_notice_timer", 0.0))
            if preserve_notice
            else 0.0
        )
        notice = (
            str(self.counter_hack.get("success_notice", ""))
            if preserve_notice
            else ""
        )
        self.counter_hack = self._blank_counter_hack()
        self.counter_hack["success_notice_timer"] = notice_timer
        self.counter_hack["success_notice"] = notice

    @staticmethod
    def _counter_hack_target_key(
        context: dict[str, object] | None,
        game_id: str,
    ) -> str:
        if context is not None and context.get("target") is not None:
            target_type = str(context.get("target_type", "цель"))
            return f"{target_type}:{context['target']}".casefold()
        return f"training:{game_id}".casefold()

    @staticmethod
    def _counter_hack_target_name(
        context: dict[str, object] | None,
        game_id: str,
    ) -> str:
        if context is not None and context.get("target") is not None:
            return str(context["target"])
        return f"тренировочный модуль {game_id}"

    def _target_cooldown_remaining(
        self,
        context: dict[str, object] | None,
        game_id: str,
    ) -> float:
        key = self._counter_hack_target_key(context, game_id)
        return max(0.0, float(self.counter_hack_cooldowns.get(key, 0.0)))

    def _target_cooldown_message(
        self,
        context: dict[str, object] | None,
        game_id: str,
    ) -> str:
        remaining = self._target_cooldown_remaining(context, game_id)
        target_name = self._counter_hack_target_name(context, game_id)
        return (
            f"Цель {target_name} недоступна ещё "
            f"{self._format_countdown(remaining)}"
        )

    def _update_counter_hack_cooldowns(self, delta_seconds: float) -> None:
        if not self.has_active_session or self.arrested:
            return
        expired: list[str] = []
        for target_key in tuple(self.counter_hack_cooldowns):
            remaining = max(
                0.0,
                float(self.counter_hack_cooldowns[target_key]) - delta_seconds,
            )
            if remaining <= 0.0:
                expired.append(target_key)
            else:
                self.counter_hack_cooldowns[target_key] = remaining
        for target_key in expired:
            del self.counter_hack_cooldowns[target_key]
        if expired and self.browser_query:
            self._update_browser_results()

    def _configure_counter_hack(
        self,
        target_level: int,
        context: dict[str, object] | None,
        game_id: str,
    ) -> bool:
        self._clear_counter_hack_attempt(preserve_notice=False)
        level = min(
            MINIGAME_DIFFICULTY_MAX,
            max(MINIGAME_DIFFICULTY_MIN, int(target_level)),
        )
        if self.counter_hack_random.random() >= counter_hack_chance[level]:
            return False
        self.counter_hack.update(
            {
                "active": True,
                "enemy_progress": 0.0,
                "enemy_speed": COUNTER_HACK_SPEED_BY_LEVEL[level],
                "triggered": False,
                "trigger_delay": self.counter_hack_random.uniform(
                    COUNTER_HACK_TRIGGER_DELAY_MIN_SECONDS,
                    COUNTER_HACK_TRIGGER_DELAY_MAX_SECONDS,
                ),
                "target_key": self._counter_hack_target_key(context, game_id),
                "target_name": self._counter_hack_target_name(context, game_id),
            }
        )
        return True

    def _counter_hack_reward_multiplier(self) -> float:
        context = self.active_hack_context
        if context is not None and bool(context.get("counter_hack_overcome")):
            return COUNTER_HACK_REWARD_MULTIPLIER
        return 1.0

    def _resolve_counter_hack_success(self) -> None:
        if (
            not bool(self.counter_hack.get("active"))
            or not bool(self.counter_hack.get("triggered"))
            or bool(self.counter_hack.get("failed"))
        ):
            return
        context = self.active_hack_context or self.pending_minigame_order
        if context is not None:
            context["counter_hack_overcome"] = True
        message = "Контр-взлом отражён! +бонус 20% BTC"
        self.counter_hack["active"] = False
        self.counter_hack["success_notice_timer"] = (
            COUNTER_HACK_SUCCESS_NOTICE_SECONDS
        )
        self.counter_hack["success_notice"] = message
        self._push_notification(
            message,
            COLOR_SUCCESS,
            sound_id="success",
    ...
    def _trigger_counter_hack_failure(self) -> None:
        if (
            not bool(self.counter_hack.get("active"))
            or not bool(self.counter_hack.get("triggered"))
            or bool(self.counter_hack.get("failed"))
            ...
            return
        target_key = str(self.counter_hack.get("target_key", ""))
        if target_key:
            self.counter_hack_cooldowns[target_key] = (
                COUNTER_HACK_TARGET_COOLDOWN_SECONDS
            )
        self.counter_hack.update(
            {
                "active": False,
                "enemy_progress": 100.0,
                "failed": True,
                "failure_glitch_timer": COUNTER_HACK_FAILURE_GLITCH_SECONDS,
            }
        )
        if self.active_minigame is not None:
            self.active_minigame.finish(False)
        self._change_balance(
            -COUNTER_HACK_BTC_PENALTY,
            "Штраф за проигранный контр-взлом",
        )
        suspicion_added = self._change_suspicion(
            COUNTER_HACK_SUSPICION_PENALTY,
            "Цель завершила контр-взлом и раскрыла соединение",
        )
        if self.arrested:
            return
        self.counter_hack["suspicion_added"] = suspicion_added
        self._play_sound("sfx_glitch")
        self._sync_music_for_state()
        self._save_game()

    def _update_counter_hack(self, delta_seconds: float) -> None:
        self._update_counter_hack_cooldowns(delta_seconds)
        self.counter_hack["success_notice_timer"] = max(
            0.0,
            float(self.counter_hack.get("success_notice_timer", 0.0))
            - delta_seconds,
        )
        if bool(self.counter_hack.get("failed")):
            self.counter_hack["failure_glitch_timer"] = max(
                0.0,
                float(self.counter_hack.get("failure_glitch_timer", 0.0))
                - delta_seconds,
            )
            return
        if not bool(self.counter_hack.get("active")):
            return
        minigame = self.active_minigame
        if minigame is None or isinstance(minigame, IntrusionDefense):
            self._clear_counter_hack_attempt()
            self._sync_music_for_state()
            return
        if minigame.finished:
            if minigame.success and bool(self.counter_hack.get("triggered")):
                self._resolve_counter_hack_success()
            else:
                self._clear_counter_hack_attempt()
                self._sync_music_for_state()
            return

        if not bool(self.counter_hack.get("triggered")):
            trigger_delay = float(self.counter_hack.get("trigger_delay", 0.0))
            trigger_delay -= delta_seconds
            self.counter_hack["trigger_delay"] = max(0.0, trigger_delay)
            if trigger_delay > 0.0:
                return
            self.counter_hack["triggered"] = True
            self.counter_hack["alert_timer"] = COUNTER_HACK_ALERT_SECONDS
            self.counter_hack["elapsed"] = 0.0
            self._play_sound("sfx_alarm")
            self._sync_music_for_state()
            return

        self.counter_hack["elapsed"] = (
            float(self.counter_hack.get("elapsed", 0.0)) + delta_seconds
        )
        self.counter_hack["alert_timer"] = max(
            0.0,
            float(self.counter_hack.get("alert_timer", 0.0)) - delta_seconds,
        )
        progress = min(
            100.0,
            float(self.counter_hack.get("enemy_progress", 0.0))
            + float(self.counter_hack.get("enemy_speed", 0.0)) * delta_seconds,
        )
        self.counter_hack["enemy_progress"] = progress
        if progress >= 100.0:
            self._trigger_counter_hack_failure()

    def _handle_counter_hack_failure_event(self, event: pygame.event.Event) -> bool:
        if not bool(self.counter_hack.get("failed")):
            return False
        if event.type == pygame.KEYDOWN and event.key == pygame.K_F11:
            return False
        if event.type != pygame.MOUSEBUTTONDOWN or event.button != 1:
        ...
        mouse = self._desktop_point(event.pos)
        if (
            float(self.counter_hack.get("failure_glitch_timer", 0.0)) <= 0.0
            and pygame.Rect(COUNTER_HACK_FAILURE_BUTTON_RECT).collidepoint(mouse)
        ):
            self.counter_hack["failed"] = False
            self._leave_minigame(report_result=True)
            self._clear_counter_hack_attempt()
        return True

    def _draw_counter_hack_bar(self) -> None:
        if not bool(self.counter_hack.get("triggered")):
            return
        if not (
            bool(self.counter_hack.get("active"))
        ...
        progress = min(
            100.0,
            max(0.0, float(self.counter_hack.get("enemy_progress", 0.0))),
        )
        bar = pygame.Rect(COUNTER_HACK_BAR_RECT)
        self._draw_text(
            "Контр-взлом противника",
            COUNTER_HACK_LABEL_CENTER,
            10,
            COLOR_ERROR,
            center=True,
            bold=True,
        ...
        pygame.draw.rect(
            self.screen,
            pygame.Color(COUNTER_HACK_BAR_BACKGROUND_HEX),
            self._window_rect(bar),
        )
        fill_width = round(bar.width * progress / 100.0)
        if fill_width > 0:
            pulse = 0.82 + 0.18 * (math.sin(self.total_elapsed * 9.0) + 1.0) / 2.0
            slices = min(50, fill_width)
            for index in range(slices):
                left = round(fill_width * index / slices)
                right = round(fill_width * (index + 1) / slices)
                gradient = index / max(1, slices - 1)
                red = round((92 + 163 * gradient) * pulse)
                pygame.draw.rect(
                    self.screen,
                    pygame.Color(red, 0, 0),
                    self._rect((bar.x + left, bar.y, max(1, right - left), bar.height)),
                )
        pygame.draw.rect(
            self.screen,
            pygame.Color(COUNTER_HACK_BAR_FILL_HEX),
            self._window_rect(bar),
            width=self._s(2),
        )
        self._draw_text(
            f"Контр-взлом: {progress:.0f}%",
            bar.center,
            10,
            COLOR_TEXT,
            center=True,
        ...
        if progress > COUNTER_HACK_CRITICAL_THRESHOLD:
            blink = int(self.total_elapsed * 8.0) % 2 == 0
            if blink:
                self._draw_text(
                    "КРИТИЧЕСКИЙ УРОВЕНЬ!",
                    COUNTER_HACK_CRITICAL_CENTER,
                    12,
                    COLOR_ERROR,
                    center=True,
                    bold=True,
    ...
    def _draw_counter_hack_alert(self) -> None:
        if float(self.counter_hack.get("alert_timer", 0.0)) <= 0.0:
            return
        if int(self.total_elapsed * 6.0) % 2 != 0:
            return
        panel = pygame.Rect(COUNTER_HACK_ALERT_RECT)
        pygame.draw.rect(
            self.screen,
            COLOR_BACKGROUND,
            self._window_rect(panel),
        ...
        self._draw_text(
            "[!] ЦЕЛЬ ОБНАРУЖИЛА ВТОРЖЕНИЕ! КОНТР-ВЗЛОМ НАЧАТ!",
            panel.center,
            18,
            COLOR_ERROR,
            center=True,
    ...
    def _draw_counter_hack_success_notice(self) -> None:
        if float(self.counter_hack.get("success_notice_timer", 0.0)) <= 0.0:
            return
        notice = str(self.counter_hack.get("success_notice", ""))
        if not notice:
            return
        panel = pygame.Rect(390, 112, 500, 52)
        pygame.draw.rect(
            self.screen,
            COLOR_BACKGROUND,
            self._window_rect(panel),
    ...
    def _apply_counter_hack_glitch(self) -> None:
        if float(self.counter_hack.get("failure_glitch_timer", 0.0)) <= 0.0:
            return
        snapshot = self.screen.copy()
        screen_width, screen_height = self.screen.get_size()
        slice_height = max(2, screen_height // COUNTER_HACK_GLITCH_SLICE_COUNT)
        for index in range(COUNTER_HACK_GLITCH_SLICE_COUNT):
            y = index * slice_height
            height = min(slice_height, screen_height - y)
            if height <= 0:
                continue
            offset = self.random.randint(
                -COUNTER_HACK_GLITCH_MAX_OFFSET,
                COUNTER_HACK_GLITCH_MAX_OFFSET,
            )
            source = pygame.Rect(0, y, screen_width, height)
            self.screen.blit(snapshot, (offset, y), source)
        noise = pygame.Surface(self.screen.get_size(), pygame.SRCALPHA)
        for _index in range(36):
            width = self.random.randint(8, 140)
            height = self.random.randint(1, 5)
            x = self.random.randint(0, max(0, screen_width - width))
            y = self.random.randint(0, max(0, screen_height - height))
            pygame.draw.rect(
                noise,
                (*COLOR_ERROR[:3], self.random.randint(35, 120)),
                pygame.Rect(x, y, width, height),
            )
        self.screen.blit(noise, (0, 0))

    def _draw_counter_hack_failure(self, mouse: tuple[float, float]) -> None:
        if not bool(self.counter_hack.get("failed")):
            return
        self._apply_counter_hack_glitch()
        dim = pygame.Surface(self.screen.get_size(), pygame.SRCALPHA)
        dim.fill((0, 0, 0, 190))
        self.screen.blit(dim, (0, 0))
        panel = pygame.Rect(COUNTER_HACK_FAILURE_PANEL_RECT)
        pygame.draw.rect(
            self.screen,
            COLOR_BACKGROUND,
            self._window_rect(panel),
            border_radius=self._s(14),
        )
        pygame.draw.rect(
            self.screen,
            COLOR_ERROR,
        ...
        self._draw_text(
            ...
            (COUNTER_HACK_FAILURE_TITLE_CENTER[0], 276),
            34,
            COLOR_ERROR,
            center=True,
            bold=True,
        ...
        self._draw_text(
            "ЦЕЛЬ ЗАБЛОКИРОВАЛА ВАС.",
            COUNTER_HACK_FAILURE_TITLE_CENTER,
            25,
            COLOR_ERROR,
            center=True,
            bold=True,
        )
        suspicion_added = float(self.counter_hack.get("suspicion_added", 0.0))
        self._draw_text(
            (
                f"Штраф -{COUNTER_HACK_BTC_PENALTY:.2f} BTC  //  "
                f"Подозрение +{suspicion_added:.0f}%  //  Кулдаун цели 02:00"
            ),
            COUNTER_HACK_FAILURE_DETAIL_CENTER,
            14,
            COLOR_TEXT,
            center=True,
        )
        if float(self.counter_hack.get("failure_glitch_timer", 0.0)) > 0.0:
            ...
            return
        button = pygame.Rect(COUNTER_HACK_FAILURE_BUTTON_RECT)
        hovered = button.collidepoint(mouse)
        pygame.draw.rect(
            self.screen,
            COLOR_HOT_ACCENT if hovered else COLOR_ERROR,
            self._window_rect(button),
            border_radius=self._s(9),
        )
        self._draw_text(
    ...
    def _draw_counter_hack_overlay(self) -> None:
        if self.state not in MINIGAME_STATES:
            self._draw_counter_hack_success_notice()
            return
        elapsed = float(self.counter_hack.get("elapsed", 0.0))
        if (
            bool(self.counter_hack.get("triggered"))
            and not bool(self.counter_hack.get("failed"))
            and elapsed % COUNTER_HACK_FRAME_PERIOD_SECONDS
            < COUNTER_HACK_FRAME_FLASH_SECONDS
        ):
            pygame.draw.rect(
                self.screen,
                COLOR_ERROR,
                self._rect((2, 2, DESIGN_WIDTH - 4, DESIGN_HEIGHT - 4)),
                width=self._s(5),
            )
        self._draw_counter_hack_bar()
        self._draw_counter_hack_alert()
        self._draw_counter_hack_success_notice()
        self._draw_counter_hack_failure(self._desktop_point(pygame.mouse.get_pos()))
    ...
    @staticmethod
    def _blank_storm_state() -> dict[str, object]:
        return {
            "active": False,
            "type": None,
            "timer": 0.0,
            ...
            "elapsed": 0.0,
            "end_notice_timer": 0.0,
            "end_notice": "",
        }

    def _reset_network_storm(self) -> None:
        if hasattr(self, "storm_state") and self._storm_effect_active("servers_hard"):
            self._remove_server_storm_hp_from_active_game()
        self.storm_state = self._blank_storm_state()
        self.next_storm_time = float(
            self.storm_random.randint(
                STORM_INTERVAL_MIN_SECONDS,
                STORM_INTERVAL_MAX_SECONDS,
            )
        )

    def _schedule_next_storm(self) -> None:
        self.next_storm_time = float(
            self.storm_random.randint(
                STORM_INTERVAL_MIN_SECONDS,
                STORM_INTERVAL_MAX_SECONDS,
    ...
    def _active_storm_type(self) -> dict[str, object] | None:
        storm = self.storm_state.get("type")
        return storm if isinstance(storm, dict) else None

    def _storm_effect_active(self, effect: str) -> bool:
        storm = self._active_storm_type()
        return (
            bool(self.storm_state.get("active"))
            and storm is not None
            and storm.get("effect") == effect
        )

    def _storm_color(self) -> pygame.Color:
        storm = self._active_storm_type()
        if storm is None:
            return COLOR_MUTED
        try:
            return pygame.Color(str(storm["color"]))
        except (KeyError, ValueError):
            return COLOR_MUTED

    def _storm_can_start(self) -> bool:
        gameplay_states = {
            STATE_DESKTOP,
            STATE_HACK_PREP,
            STATE_POST_HACK,
        ...
        return (
            self.has_active_session
            and not self.arrested
            and self.state in gameplay_states
            and not bool(self.storm_state.get("active"))
            and not bool(self.call_state.get("active"))
            and not bool(self.counter_hack.get("failed"))
        )

    def _start_network_storm(
        self,
        storm: dict[str, object] | None = None,
    ) -> bool:
        if not self._storm_can_start():
            return False
        selected = storm or self.storm_random.choice(storm_types)
        effect = str(selected.get("effect", ""))
        canonical = next(
            (item for item in storm_types if item["effect"] == effect),
            None,
        )
        ...
        self.storm_state = {
            ...
            "type": dict(canonical),
            "timer": duration,
            "announcement_timer": STORM_ANNOUNCEMENT_SECONDS,
            "elapsed": 0.0,
        }
        if effect == "income_x3":
            darknet_windows = [
            ...
            for window in darknet_windows:
                self._close_desktop_window(window)
        elif effect == "servers_hard":
            self._apply_server_storm_hp_to_active_game()
        self._play_sound("sfx_alarm")
        self._update_browser_results()
        self._sync_music_for_state()
        self._save_game()
    ...
    def _end_network_storm(self) -> None:
        storm = self._active_storm_type()
        if not bool(self.storm_state.get("active")) or storm is None:
            return
        name = str(storm["name"])
        if storm.get("effect") == "servers_hard":
            self._remove_server_storm_hp_from_active_game()
        self.storm_state = self._blank_storm_state()
        self.storm_state["end_notice_timer"] = STORM_END_NOTIFICATION_SECONDS
        self.storm_state["end_notice"] = f"[NET] Шторм '{name}' закончился."
        self._schedule_next_storm()
        self._update_browser_results()
        self._sync_music_for_state()
        self._push_notification(
            f"🌐 Шторм '{name}' закончился.",
            COLOR_MUTED,
            sound_id="notification",
            force=True,
            duration=STORM_END_NOTIFICATION_SECONDS,
        )
        self._save_game()

    def _update_network_storm(self, delta_seconds: float) -> None:
        if not self.has_active_session or self.arrested:
            return
        self.storm_state["end_notice_timer"] = max(
            0.0,
            float(self.storm_state.get("end_notice_timer", 0.0)) - delta_seconds,
        )
        if bool(self.storm_state.get("active")):
            self.storm_state["timer"] = max(
                0.0,
                float(self.storm_state.get("timer", 0.0)) - delta_seconds,
            )
            self.storm_state["announcement_timer"] = max(
                0.0,
                float(self.storm_state.get("announcement_timer", 0.0))
                - delta_seconds,
            )
            self.storm_state["elapsed"] = (
                float(self.storm_state.get("elapsed", 0.0)) + delta_seconds
            )
            if float(self.storm_state["timer"]) <= 0.0:
                self._end_network_storm()
            return
        self.next_storm_time -= delta_seconds
        if self.next_storm_time <= 0.0 and self._storm_can_start():
            self._start_network_storm()

    def _storm_order_reward_multiplier(self) -> float:
        return (
            STORM_ORDER_REWARD_MULTIPLIER
            if self._storm_effect_active("targets_easier")
            else 1.0
        )

    def _payable_order_reward(self, order: dict[str, object]) -> float:
        return round(
            float(order.get("reward", 0.0)) * self._storm_order_reward_multiplier(),
            6,
        )

    def _storm_income_multiplier(self) -> float:
        return (
            STORM_INCOME_MULTIPLIER
            if self._storm_effect_active("income_x3")
            else 1.0
        )

    def _darknet_closed_by_storm(self) -> bool:
        return self._storm_effect_active("income_x3")

    def _storm_botnet_is_free(self) -> bool:
        return self._storm_effect_active("servers_hard")

    @staticmethod
    def _is_server_target_context(context: dict[str, object] | None) -> bool:
        if context is None:
            return False
        target_type = str(context.get("target_type", ""))
        parameters = TARGET_TYPES.get(target_type)
        return parameters is not None and parameters.get("category") == "server"

    def _active_ddos_is_server_target(self) -> bool:
        if not isinstance(self.active_minigame, DDoSClicker):
            return False
        context = self.active_hack_context or self.pending_minigame_order
        return self._is_server_target_context(context) or context is None

    def _apply_server_storm_hp_to_active_game(self) -> None:
        if not self._active_ddos_is_server_target():
            return
        minigame = self.active_minigame
        if not isinstance(minigame, DDoSClicker) or bool(
            getattr(minigame, "storm_hp_applied", False)
        ):
            return
        original_max = minigame.max_hp
        original_hp = minigame.hp
        minigame.storm_original_max_hp = original_max
        minigame.storm_hp_applied = True
        minigame.max_hp = math.ceil(original_max * STORM_SERVER_HP_MULTIPLIER)
        minigame.hp = (
            minigame.max_hp
            if original_hp >= original_max
            else math.ceil(original_hp * STORM_SERVER_HP_MULTIPLIER)
        )

    def _remove_server_storm_hp_from_active_game(self) -> None:
        minigame = self.active_minigame
        if not isinstance(minigame, DDoSClicker) or not bool(
            getattr(minigame, "storm_hp_applied", False)
        ):
            return
        original_max = max(
            1,
            int(getattr(minigame, "storm_original_max_hp", minigame.max_hp)),
        )
        ratio = minigame.hp / max(1, minigame.max_hp)
        minigame.max_hp = original_max
        minigame.hp = (
            0
            if minigame.hp <= 0
            else min(original_max, max(1, math.ceil(original_max * ratio)))
        )
        minigame.storm_hp_applied = False

    def _draw_storm_globe(self) -> None:
        center = self._point(STORM_GLOBE_CENTER)
        radius = self._s(STORM_GLOBE_RADIUS)
        color = self._storm_color()
        pygame.draw.circle(self.screen, color, center, radius, self._s(3))
        pygame.draw.ellipse(
            self.screen,
            color,
            pygame.Rect(
    ...
    def _draw_storm_frame(self) -> None:
        if not bool(self.storm_state.get("active")) or self.state != STATE_DESKTOP:
            return
        color = self._storm_color()
        pulse_on = int(float(self.storm_state.get("elapsed", 0.0)) * 2.0) % 2 == 0
        frame_color = color if pulse_on else color.lerp(COLOR_BACKGROUND, 0.42)
        pygame.draw.rect(
            self.screen,
            frame_color,
            self._rect(
                (
                    ...
                    DESIGN_WIDTH - 4,
                    DESIGN_HEIGHT - DESKTOP_TASKBAR_HEIGHT - 2,
                )
            ),
            width=self._s(STORM_FRAME_WIDTH),
        )

    def _draw_storm_announcement(self) -> None:
        if (
            not bool(self.storm_state.get("active"))
            or float(self.storm_state.get("announcement_timer", 0.0)) <= 0.0
        ):
            return
        storm = self._active_storm_type()
        if storm is None:
        ...
        dim.fill((0, 0, 0, 220))
        self.screen.blit(dim, (0, 0))
        self._draw_storm_globe()
        self._draw_text(
            "СЕТЕВОЙ ШТОРМ",
            STORM_ANNOUNCEMENT_TITLE_CENTER,
            38,
            COLOR_TEXT,
            center=True,
            bold=True,
        ...
        pygame.draw.circle(
            self.screen,
            color,
            self._point((470, STORM_ANNOUNCEMENT_NAME_CENTER[1] + 13)),
            self._s(12),
        )
        self._draw_text(
            str(storm["name"]),
            STORM_ANNOUNCEMENT_NAME_CENTER,
            28,
            color,
            center=True,
            bold=True,
        ...
        self._draw_text(
            str(storm["desc"]),
            STORM_ANNOUNCEMENT_DESC_CENTER,
            18,
            COLOR_TEXT,
            center=True,
        )
        self._draw_text(
            f"Длительность: {self._format_countdown(float(storm['duration']))}",
            STORM_ANNOUNCEMENT_DURATION_CENTER,
            17,
            COLOR_MUTED,
            center=True,
            bold=True,
    ...
    def _draw_storm_taskbar_status(self) -> None:
        if not bool(self.storm_state.get("active")):
            return
        storm = self._active_storm_type()
        if storm is None:
            return
        rect = pygame.Rect(STORM_TASKBAR_STATUS_RECT)
        pygame.draw.rect(
            self.screen,
            COLOR_BACKGROUND,
            self._window_rect(rect),
        ...
        blink_on = int(float(self.storm_state.get("elapsed", 0.0)) * 2.0) % 2 == 0
        pygame.draw.circle(
            self.screen,
            color if blink_on else COLOR_BACKGROUND,
            self._point((rect.x + 13, rect.centery)),
            self._s(6),
        )
        label = {
            "targets_easier": "DATA LEAK",
            "suspension_x2": "POLICE SCAN",
            "income_x3": "BTC BOOM",
            "servers_hard": "DDoS WAVE",
            "shop_discount": "DARK SALE",
        }.get(str(storm.get("effect", "")), str(storm["name"]).upper())
        label = self._fit_text(
            f"{label} {self._format_countdown(float(self.storm_state.get('timer', 0.0)))}",
            self._font(8, True),
            self._s(rect.width - 26),
        )
        self._draw_text(
            label,
            (rect.x + 24, rect.y + 9),
            8,
            color if blink_on else COLOR_MUTED,
            bold=True,
        )

    def _draw_storm_end_notice(self) -> None:
        if float(self.storm_state.get("end_notice_timer", 0.0)) <= 0.0:
            return
        panel = pygame.Rect(390, 92, 500, 54)
        pygame.draw.rect(
            self.screen,
            COLOR_BACKGROUND,
            self._window_rect(panel),
        ...
        self._draw_text(
            str(self.storm_state.get("end_notice", "")),
            panel.center,
            14,
            COLOR_MUTED,
            center=True,
    ...
    def _draw_network_storm_overlay(self) -> None:
        self._draw_storm_frame()
        self._draw_storm_end_notice()
        self._draw_storm_announcement()
    ...
    def _handle_event(self, event: pygame.event.Event) -> None:
        ...
        if bool(self.call_state.get("active")) and self._handle_incoming_call_event(
            ...
            return
        if bool(self.counter_hack.get("failed")) and (
            self._handle_counter_hack_failure_event(event)
        ):
            return
    ...
    def _handle_minigame_event(self, event: pygame.event.Event) -> None:
        if self.active_minigame is None:
            return
        if self._handle_counter_hack_failure_event(event):
            return
        if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
    ...
    def _save_payload(self) -> dict[str, object]:
        return {
            ...
            "counter_hack": self.counter_hack,
            "counter_hack_cooldowns": self.counter_hack_cooldowns,
            "storm_state": self.storm_state,
            "next_storm_time": self.next_storm_time,
    ...
    def _load_counter_hack_state(self, payload: dict[str, object]) -> None:
        self._reset_counter_hack_system(clear_cooldowns=True)
        cooldowns_value = payload.get("counter_hack_cooldowns")
        if isinstance(cooldowns_value, dict):
            self.counter_hack_cooldowns = {
                str(target_key)[:160]: min(
                    COUNTER_HACK_TARGET_COOLDOWN_SECONDS,
                    max(0.0, float(remaining)),
                )
                for target_key, remaining in cooldowns_value.items()
                if isinstance(remaining, (int, float)) and float(remaining) > 0.0
            }

    def _load_network_storm_state(self, payload: dict[str, object]) -> None:
        self.next_storm_time = max(
            0.0,
            float(payload.get("next_storm_time", self.next_storm_time)),
        )
        loaded_state = payload.get("storm_state")
        if not isinstance(loaded_state, dict) or not bool(loaded_state.get("active")):
            self.storm_state = self._blank_storm_state()
            return
        loaded_type = loaded_state.get("type")
        effect = (
            str(loaded_type.get("effect", ""))
            if isinstance(loaded_type, dict)
            else ""
        )
        canonical = next(
            (item for item in storm_types if item["effect"] == effect),
        ...
        if canonical is None:
            ...
            return
        timer = min(
            float(canonical["duration"]),
            max(0.0, float(loaded_state.get("timer", 0.0))),
        )
        if timer <= 0.0:
            self.storm_state = self._blank_storm_state()
            return
        self.storm_state = {
            ...
            "type": dict(canonical),
            "timer": timer,
            "announcement_timer": min(
                STORM_ANNOUNCEMENT_SECONDS,
                max(
                    0.0,
                    float(loaded_state.get("announcement_timer", 0.0)),
                ),
            ),
            "elapsed": max(0.0, float(loaded_state.get("elapsed", 0.0))),
        }
    ...
    def _load_game(self, path: Path, *, notify: bool = True) -> bool:
        try:
            ...
            self._load_counter_hack_state(payload)
            self._load_network_storm_state(payload)
            if self.arrested:
                self._reset_live_events()
                self._reset_counter_hack_system(clear_cooldowns=True)
                self._reset_network_storm()
    ...
    def _change_balance(
        ...
        *,
        apply_income_modifiers: bool = True,
    ) -> float:
        """Меняет баланс и добавляет запись в журнал CryptoWallet."""
        applied_amount = float(amount)
        if applied_amount > 0.0 and apply_income_modifiers:
            applied_amount *= self._storm_income_multiplier()
            applied_amount *= self._counter_hack_reward_multiplier()
        self.btc_balance += applied_amount
    ...
    def _change_suspicion(self, amount: float, reason: str = "") -> float:
        ...
        applied_amount = float(amount)
        if applied_amount > 0.0 and self._storm_effect_active("suspension_x2"):
            applied_amount *= STORM_POLICE_SUSPICION_MULTIPLIER
        self.suspicion = min(
            SUSPICION_MAX,
            max(SUSPICION_MIN, previous + applied_amount),
        )
    ...
    def _effective_target_difficulty(self, base_difficulty: int) -> int:
        ...
        if self._storm_effect_active("targets_easier"):
            reduction += STORM_TARGET_DIFFICULTY_REDUCTION
        return min(
            MINIGAME_DIFFICULTY_MAX,
    ...
    def _darknet_effective_price(self, product: dict[str, object]) -> float:
        ...
        if self._storm_effect_active("shop_discount"):
            price *= STORM_SHOP_DISCOUNT_MULTIPLIER
        return round(price, 6)

    def _purchase_darknet_product(self, product: dict[str, object]) -> bool:
        if self._darknet_closed_by_storm():
            self._push_notification(STORM_DARKNET_CLOSED_MESSAGE, COLOR_MUTED, force=True)
            return False
    ...
    def _order_message(self, order: dict[str, object]) -> str:
        if bool(order.get("is_hot_deal")):
            return self._hot_deal_message(order)
        reward = self._payable_order_reward(order)
    ...
    def _push_notification(
        ...
        *,
        ...
        force: bool = False,
        duration: float = DESKTOP_NOTIFICATION_DURATION_SECONDS,
    ) -> None:
    ...
    def _update_hacker_attack_timer(self, delta_seconds: float) -> None:
        if (
            ...
            return
        attack_speed = (
            STORM_POLICE_ATTACK_SPEED_MULTIPLIER
            if self._storm_effect_active("suspension_x2")
            else 1.0
        )
        self.hacker_attack_timer -= delta_seconds * attack_speed
        if (
    ...
    def _process_order(self, customer: str, decision: str) -> None:
        ...
        if order is None or order.get("status") != "pending":
            return
        cooldown_context = {
            "target": order.get("target", customer),
            "target_type": order.get("target_type", "Обычный ПК"),
        }
        if (
            decision == "accepted"
    ...
    def _update_desktop_timers(self, delta_seconds: float) -> None:
        ...
        if (
            ...
            miner_income *= self._storm_income_multiplier()
    ...
    def _start_browser_hack(self) -> None:
        ...
        if self._target_cooldown_remaining(context, game_id) > 0.0:
            self._push_notification(
                self._target_cooldown_message(context, game_id),
                COLOR_ERROR,
                force=True,
            )
            return
    ...
    def _open_desktop_window(self, app_id: str) -> None:
        if app_id == DARKNET_APP_ID and self._darknet_closed_by_storm():
            self._push_notification(
                STORM_DARKNET_CLOSED_MESSAGE,
                COLOR_MUTED,
                force=True,
    ...
    def _prepare_hack(
        ...
        *,
        ...
        if self._target_cooldown_remaining(hack_context, game_id) > 0.0:
            self._push_notification(
                self._target_cooldown_message(hack_context, game_id),
                COLOR_ERROR,
                force=True,
            )
            return
    ...
    def _launch_prepared_hack(self) -> None:
        ...
        if "botnet_pc" in selected_tools and context is not None:
            botnet_free = self._storm_botnet_is_free()
            if not botnet_free:
            ...
            botnet_message = (
                "Ботнет выполнил бесплатный авто-взлом во время DDoS-волны"
                if botnet_free
                else "Ботнет выполнил авто-взлом ПК"
            )
            self._push_notification(
                botnet_message,
                COLOR_SUCCESS,
    ...
    def _start_minigame(
        ...
        *,
        ...
        if self._target_cooldown_remaining(effective_context, game_id) > 0.0:
            self._push_notification(
                self._target_cooldown_message(effective_context, game_id),
                COLOR_ERROR,
                force=True,
            )
            return
        ...
        if self._storm_effect_active("servers_hard"):
            self._apply_server_storm_hp_to_active_game()
        self._configure_counter_hack(
            game_difficulty,
            effective_context,
            game_id,
        )
    ...
    def _leave_minigame(self, *, report_result: bool = False) -> None:
        ...
        if bool(self.counter_hack.get("active")):
            if game_succeeded and bool(self.counter_hack.get("triggered")):
                self._resolve_counter_hack_success()
            else:
                self._clear_counter_hack_attempt()
                self._sync_music_for_state()
            ...
            not game_succeeded
            and bool(self.counter_hack.get("triggered"))
            and not bool(self.counter_hack.get("failed"))
        ):
            self._clear_counter_hack_attempt()
            self._sync_music_for_state()
    ...
    def _deliver_order_information(self) -> bool:
        ...
        if not self.story_finale_reached:
            self._issue_due_story_order(customer)
        reward = (
            self._payable_order_reward(order_reference)
            if isinstance(order_reference, dict)
            else round(
                float(reward_value) * self._storm_order_reward_multiplier(),
                6,
            )
        )
        paid_reward = self._change_balance(reward, f"Заказ #{order_id:03d}")
        message = (
            f"Информация передана. Награда ₿ {paid_reward:.3f} и "
    ...
    def _apply_post_hack_action(self, action: str) -> None:
        ...
        if action == "miner":
            ...
            if any(str(miner["key"]) == miner_key for miner in self.miner_targets):
                ...
                counter_multiplier = self._counter_hack_reward_multiplier()
                miner_rate = MINER_RATE_BTC_PER_MINUTE * counter_multiplier
                ...
                if used_payload:
                    bootstrap_reward = (
                        MALWARE_MINER_BOOTSTRAP_BTC
                        * self._storm_income_multiplier()
                        * counter_multiplier
                    )
                    self.miner_pending_income += bootstrap_reward
                    self.miner_earned_total += bootstrap_reward
                payload_text = (
                    f"; payload +₿ {bootstrap_reward:.3f}" if used_payload else ""
                )
                message = (
                    f"Майнер добавлен: {target_name} "
                    f"(+{miner_rate:.3f} BTC/мин{payload_text})"
                )
                color = COLOR_SUCCESS
            ...
            paid_reward = self._change_balance(reward, "Продажа данных")
            spy_text = " • использован Шпион" if used_spy else ""
            self._finish_post_hack(
                f"Данные проданы: +₿ {paid_reward:.3f}{spy_text}",
                COLOR_SUCCESS,
            )
            ...
            paid_reward = self._change_balance(reward, "Выкуп шифровальщика")
            suspicion_added = self._change_suspicion(
            ...
            self._finish_post_hack(
                (
                    f"Выкуп получен: +₿ {paid_reward:.3f}; "
                    f"подозрение +{suspicion_added:.0f}%{payload_text}"
                ),
                COLOR_ERROR,
            )
    ...
    def _apply_blackmail_tone(self, tone_id: str) -> None:
        ...
        if self.order_random.random() <= chance:
            ...
            paid_reward = self._change_balance(reward, f"Шантаж: {tone['name']}")
            self._finish_post_hack(
                (
                    f"Шантаж успешен ({tone['name']}): "
                    f"+₿ {paid_reward:.3f}{keylogger_text}"
                ),
                COLOR_SUCCESS,
            )
        else:
    ...
    def _update(self, delta_seconds: float) -> None:
        ...
        self._update_network_storm(delta_seconds)
        ...
        self._update_counter_hack(delta_seconds)
    ...
    def _draw_desktop_icons(self, mouse: tuple[float, float]) -> None:
        ...
        for index, (app_id, title, symbol) in enumerate(DESKTOP_APPS):
            ...
            darknet_disabled = (
                app_id == DARKNET_APP_ID and self._darknet_closed_by_storm()
            )
            fill_color = (
                COLOR_TASKBAR
                if darknet_disabled
            ...
            if hovered and not darknet_disabled:
            ...
            self._draw_text(
                ...
                COLOR_MUTED if darknet_disabled else COLOR_TEXT,
                center=True,
                bold=True,
            )
            self._draw_text(
    ...
    def _draw_messenger_messages(
        ...
        for message in self.messenger_messages[selected]:
            ...
            if (
                ...
                message_text = self._order_message(active_order)
            display_text = self._event_display_text(message_text)
    ...
    def _draw_messenger_forum(self, window: DesktopWindow) -> None:
        ...
        for index, order in enumerate(self.messenger_forum_orders):
            ...
            self._draw_text(
                f"₿ {self._payable_order_reward(order):.3f}  •  {timer}",
                (
    ...
    def _draw_browser_content(
        ...
        for index, target in enumerate(self.browser_results):
            ...
            cooldown_context = {
                "target": target.get("name", "цель"),
                "target_type": target.get("target_type", "Обычный ПК"),
            }
            cooldown = self._target_cooldown_remaining(cooldown_context, "")
            protection = f"ЗАЩИТА: {target['protection']}  {difficulty_text}"
            if cooldown > 0.0:
                protection = f"БЛОК {self._format_countdown(cooldown)}  //  {protection}"
        ...
        if self.browser_selected_target is not None:
            ...
            selected_context = {
                "target": self.browser_selected_target.get("name", "цель"),
                "target_type": self.browser_selected_target.get(
                    "target_type",
                    "Обычный ПК",
                ),
            }
            cooldown = self._target_cooldown_remaining(selected_context, "")
            locked = cooldown > 0.0
            pygame.draw.rect(
                self.screen,
                COLOR_PANEL
            ...
            self._draw_text(
                f"Недоступна {self._format_countdown(cooldown)}"
                if locked
                else "Взломать",
                hack_rect.center,
                BROWSER_HEADER_FONT_SIZE,
                COLOR_ERROR if locked else COLOR_BACKGROUND,
                center=True,
                bold=True,
            )
    ...
    def _draw_darknet_content(
        ...
        if self._darknet_closed_by_storm():
            ...
            self._draw_text(
                "DARKNET // OFFLINE",
                (content.centerx, content.centery - 24),
                28,
                COLOR_MUTED,
                center=True,
                bold=True,
            ...
            self._draw_text(
                STORM_DARKNET_CLOSED_MESSAGE,
                (content.centerx, content.centery + 22),
                15,
                COLOR_ERROR,
                center=True,
            )
        ...
        if self._storm_effect_active("shop_discount"):
            category_heading += "  •  ТЁМНАЯ ПЯТНИЦА -50%"
        self._draw_text(
            category_heading,
            (
        ...
        for slot, product in enumerate(self._darknet_visible_products()):
            ...
            price_x = card.x + DARKNET_CARD_PRICE_OFFSET[0]
            price_y = card.y + DARKNET_CARD_PRICE_OFFSET[1]
            if self._storm_effect_active("shop_discount"):
                pre_storm_price = float(product["price"])
                if self.darknet_discount_timer > 0.0:
                    pre_storm_price *= 1.0 - CALL_INFORMANT_DISCOUNT_RATE
                self._draw_text(
                    f"{pre_storm_price:.3f}",
                    (price_x, price_y),
                    DARKNET_TEXT_FONT_SIZE,
                    COLOR_MUTED,
                    bold=True,
                ...
                pygame.draw.line(
                    self.screen,
                    COLOR_ERROR,
                    self._point((price_x, price_y + 7)),
                    self._point((price_x + 42, price_y + 7)),
                    self._s(2),
                )
                self._draw_text(
                    f"> {effective_price:.3f}",
                    (price_x + 50, price_y),
                    DARKNET_TEXT_FONT_SIZE,
    ...
    def _draw_btc_balance(self) -> None:
        ...
        crypto_boom_flash = self._storm_effect_active("income_x3") and (
            int(self.total_elapsed * 2.0) % 2 == 0
        )
        balance_color = COLOR_GOLD if crypto_boom_flash else COLOR_TEXT
        bitcoin_image = font.render("B", True, balance_color)
        number_image = font.render(number_text, True, balance_color)
    ...
    def _draw_desktop_taskbar(self, mouse: tuple[float, float]) -> None:
        ...
        self._draw_storm_taskbar_status()
    ...
    def _draw_desktop_launcher(self, mouse: tuple[float, float]) -> None:
        ...
        for index, (app_id, title, symbol) in enumerate(DESKTOP_APPS):
            ...
            self._draw_text(
                f"{title} [OFF]" if darknet_disabled else title,
    ...
    def _draw_post_hack(self) -> None:
        ...
        display_reward = round(
            float(context.get("reward", 0.0))
            * self._storm_order_reward_multiplier()
            * self._counter_hack_reward_multiplier(),
            6,
        )
        associated_text = (
            f"ЗАКАЗ #{int(context['order_id']):03d} • "
            f"НАГРАДА ₿ {display_reward:.3f}"
    ...
    def _draw(self) -> None:
        ...
        self._draw_network_storm_overlay()
        self._draw_counter_hack_overlay()
